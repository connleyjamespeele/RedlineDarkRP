...
TEAM_CIVILIAN = DarkRP.createJob("Civilian", {
    ...
    description = [[A basic civilian with access to various entities and delivery services.
Entities/Weapons:
- Umbrella
- Delivery Terminal: Press E to access delivery options (Short, Medium, Large)
- Tip Jar: Receive tips from generous players
- Printers: Basic money printers (illegal unless stored with bank manager)]],
    weapons = {},
    command = "civilian",
    max = 0,
    salary = 50,
...
TEAM_NUCLEAR_WORKER = DarkRP.createJob("Nuclear Worker", {
    ...
    description = [[Manage nuclear reactors, handle heat and waste disposal.
Entities:
- Reactor: Maintain heat levels and waste
- Terminal: Facility management and upgrades
- Cooling Barrel: Cool the reactor
- Waste Barrel: Dispose legally or illegally
- Worker: Automated management with disposal options]],
    weapons = {},
...
GAMEMODE.DefaultTeam = TEAM_CIVILIAN-- People often copy jobs. When they do, the GM table does not exist anymore.
-- This line makes the job code work both inside and outside of gamemode files.
-- You should not copy this line into your code.
local GAMEMODE = GAMEMODE or GM
--[[--------------------------------------------------------
